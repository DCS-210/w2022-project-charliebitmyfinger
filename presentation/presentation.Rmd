...
The year this data is taken from was not provided but we are told it "includes several months (and counting)."
...
.pull-left[
```{r likes-views, echo = FALSE, message = FALSE, out.width = "150%"}
...
.pull-right[
```{r likes-views-faceted, echo=FALSE, message=FALSE, out.width= "150%"}
...
```{r boring-regression, echo=FALSE, warning=FALSE, message=FALSE}
# a boring regression
