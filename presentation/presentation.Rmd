...
We aim to examine what makes a Youtube video popular using a dataset from Kaggle.com, containing trending Youtube video statistics.

```{r, out.width='35%', fig.align='center', echo = FALSE}
knitr::include_graphics('img/wired-youtube.jpg.webp')
```

The Kaggle dataset used contains data from 10 different countries, but for the purpose of this project, we will stick to data from the U.S.
---
