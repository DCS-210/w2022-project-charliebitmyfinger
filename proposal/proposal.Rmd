...
```{r jh-plot}
yt %>%
  ggplot(data = yt, mapping = aes(x = publish_time, y = views, color = factor(category))) +
  geom_point(alpha = 0.15) +
  geom_smooth(method = "lm", se = FALSE) +
  labs(
    title = "The Relationship Between YouTube Views and Publish Time",
