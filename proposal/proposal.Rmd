...
ggplot(data = yt, mapping = aes(x = likes, y = views)) +
  geom_point(size = 0.5) + 
  labs( "Views vs. Likes", x="Likes", y="Views") + 
...
>>>>>>> 388f3f0b349c861dab91bf600b3b6bdcee65aa6b

```{r views-v-dislikes}
#views v dislikes
ggplot(data = yt, mapping = aes(x = dislikes, y = views)) +
  geom_point(size = 0.5) + 
  labs( "Views vs. Dislikes", x="Dislikes", y="Views") + 
  scale_y_continuous(labels = label_number(suffix = " M", scale = 1e-6)) +
  scale_x_continuous(labels = label_number(suffix = " M", scale = 1e-6))
...
ggplot(data = yt, mapping = aes(x = dislikes, y = views), alpha = 0.1) +
  geom_point(size = 0.5) + 
  labs( "Views vs. Dislikes", x="Dislikes", y="Views") + 
  scale_y_continuous(labels = label_number(suffix = " M", scale = 1e-6)) +
  geom_smooth(method = "lm", se = FALSE, color = "red") + 
...
```{r views-v-comments}
#views v comments
ggplot(data = yt, mapping = aes(x = comment_count, y = views)) +
  geom_point(size = 0.5) + 
  labs( "Views vs. Comments", x="Comment Count", y="Views") + 
  scale_y_continuous(labels = label_number(suffix = " M", scale = 1e-6)) +
  scale_x_continuous(labels = label_number(suffix = " M", scale = 1e-6))
...
ggplot(data = yt, mapping = aes(x = comment_count, y = views), alpha = 0.1) +
  geom_point(size = 0.5) + 
  labs( "Views vs. Comments", x="Comment Count", y="Views") + 
  scale_y_continuous(labels = label_number(suffix = " M", scale = 1e-6)) +
  geom_smooth(method = "lm", se = FALSE, color = "red") + 
...
ggplot(data = max_views_vid_for_each_channel, mapping = aes(x = reorder(channel_title, max_views), y = max_views)) +
  ...
  scale_y_continuous(labels = label_number(suffix = " M", scale = 1e-6)) +
  labs( "Max Views Video For Each Channel", x="Channel Title", y="Number of Views on Most-Viewed Video")

```

## Views vs. Date Published

```{r views-v-date-published}
