...
```{r data-visual}
<<<<<<< HEAD
ggplot(data = yt, mapping = aes(x = views, y = likes, color = publish_time), alpha = 0.1) +
  geom_point(size = 0.5) +
...
>>>>>>> 8112da0fddb88d18aaf1402c4f42d93115f68cf2

ggplot(data = yt, mapping = aes(x = views, y = dislikes, color = category)) +
  geom_point(size = 0.5) +
  scale_y_continuous(labels = label_number(suffix = " M", scale = 1e-6)) +
  facet_wrap(~category)
...
=======
  scale_x_date(limit=c(as.Date("2017-10-15 18:59:30 UTC"), as.Date("2018-6-30 18:59:30 UTC")), date_breaks = "1 month", date_labels = "%y-%m") + ylim(0, 100000000)+ scale_y_continuous(labels = label_number(suffix = " M", scale = 1e-6))
>>>>>>> 8112da0fddb88d18aaf1402c4f42d93115f68cf2
```
