...
ggplot(data = views_for_category) +
  ...
  geom_point( aes(x=reorder(category, mean_views), y=median_views), color= "green", size=2 ) +
  geom_point( aes(x=reorder(category, mean_views), y=mean_views), color= "purple", size=2 ) +
 theme(legend.position = 'none') +
  coord_flip() + 
  scale_y_continuous(labels = label_number(suffix = " M", scale = 1e-6)) +
  labs( title = "Mean and Median Views For Each Category", subtitle = "green is median, purple is mean", x=" Number of Views", y="Category")
